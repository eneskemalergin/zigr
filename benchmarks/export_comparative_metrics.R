...
export_separated_metrics <- function() {
  ...
  task_cells <- data.frame(
    ...
    first_call_ms = as.numeric(summaries$first_call_ms),
    rss_endpoint_delta_kb = as.numeric(summaries$rss_endpoint_delta_kb),
    rss_endpoint_metric = as.character(summaries$rss_endpoint_metric),
    rss_endpoint_support = as.character(summaries$rss_endpoint_support),
    rss_endpoint_support_reason = as.character(summaries$rss_endpoint_support_reason),
    peak_rss_kb = as.numeric(summaries$peak_rss_kb),
    loaded_process_rss_kb = as.numeric(summaries$loaded_process_rss_kb),
    peak_rss_metric = as.character(summaries$peak_rss_metric),
    peak_rss_support = as.character(summaries$peak_rss_support),
    peak_rss_support_reason = as.character(summaries$peak_rss_support_reason),
    peak_rss_repetitions = as.integer(summaries$peak_rss_repetitions),
  ...
  fixture_cells <- data.frame(
    ...
    first_call_ms = as.numeric(fixture_summaries$first_call_ms),
    rss_endpoint_delta_kb = as.numeric(fixture_summaries$rss_endpoint_delta_kb),
    rss_endpoint_metric = as.character(fixture_summaries$rss_endpoint_metric),
    rss_endpoint_support = as.character(fixture_summaries$rss_endpoint_support),
    rss_endpoint_support_reason = as.character(fixture_summaries$rss_endpoint_support_reason),
    peak_rss_kb = as.numeric(fixture_summaries$peak_rss_kb),
    loaded_process_rss_kb = as.numeric(fixture_summaries$loaded_process_rss_kb),
    peak_rss_metric = as.character(fixture_summaries$peak_rss_metric),
    peak_rss_support = as.character(fixture_summaries$peak_rss_support),
    peak_rss_support_reason = as.character(fixture_summaries$peak_rss_support_reason),
    peak_rss_repetitions = as.integer(fixture_summaries$peak_rss_repetitions),
  ...
  report_metric_columns <- report_measurement_columns()
  product_output <- product[, c(
    ...
    "reason", "owner", "correctness_status", report_metric_columns,
  ...
  r_output <- r_baseline[, c(
    ...
    "backend_provenance", "correctness_status", report_metric_columns,
    "median_ms", "median_ci_low_ms", "median_ci_high_ms",
    "cv_pct", "timer_noise_floor_ms", "timer_noise_status", "n_iterations", "sample_stage",
    "zigr_median_ms", "zigr_median_ci_low_ms",
  ...
  diagnostic_output <- diagnostic[, c(
    ...
    "correctness_message", report_metric_columns,
    "median_ms", "median_ci_low_ms", "median_ci_high_ms", "cv_pct",
  ...
  manifest_record <- list(
    ...
    report_policy = list(
      ...
      peak_rss_repetitions = as.integer(timing_policy$peak_rss_repetitions),
      peak_rss_fixture_ids = as.character(timing_policy$peak_rss_fixture_ids),
