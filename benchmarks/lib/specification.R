...
build_analysis_summary <- function(summaries, manifest, run_id) {
  ...
  data.frame(
    ...
    block_size = summary_column("block_size"),
    max_iterations = summary_column("max_iterations"),
    convergence_window_blocks = summary_column("convergence_window_blocks"),
    convergence_cv_threshold_pct = summary_column("convergence_cv_threshold_pct"),
    convergence_cv_pct = summary_column("convergence_cv_pct"),
    stopping_condition = summary_column("stopping_condition", "legacy"),
    converged = summary_column("converged"),
