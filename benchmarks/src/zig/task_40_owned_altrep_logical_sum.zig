...
const BenchAltLogical = altrep_create.AltLogical("zigrbench", "bench_altlogical_owned_sum");
...
export fn zigr_bench_owned_altrep_logical_sum(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarReal(@floatFromInt(convert.countTrue(vec)));
}
