...
const BenchAltInteger = altrep_create.AltInteger("zigrbench", "bench_altinteger_owned_min");
...
export fn zigr_bench_owned_altrep_int_min(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarInteger(convert.minInt(vec));
}
