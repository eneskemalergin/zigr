...
const BenchAltInteger = altrep_create.AltInteger("zigrbench", "bench_altinteger_owned_sum");
...
export fn zigr_bench_owned_altrep_int_sum(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarReal(@floatFromInt(convert.sumInt(vec)));
}
