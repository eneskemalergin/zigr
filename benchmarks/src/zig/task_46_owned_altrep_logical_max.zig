...
const BenchAltLogical = altrep_create.AltLogical("zigrbench", "bench_altlogical_owned_max");
...
export fn zigr_bench_owned_altrep_logical_max(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarLogical(convert.maxLogical(vec));
}
