...
const BenchAltInteger = altrep_create.AltInteger("zigrbench", "bench_altinteger_owned_argmin");
...
export fn zigr_bench_owned_altrep_int_argmin(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarInteger(@intCast(convert.argminInt(vec)));
}
