...
const BenchAltLogical = altrep_create.AltLogical("zigrbench", "bench_altlogical_owned_min");
...
export fn zigr_bench_owned_altrep_logical_min(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarLogical(convert.minLogical(vec));
}
