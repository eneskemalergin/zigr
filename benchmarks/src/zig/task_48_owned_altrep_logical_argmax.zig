...
const BenchAltLogical = altrep_create.AltLogical("zigrbench", "bench_altlogical_owned_argmax");
...
export fn zigr_bench_owned_altrep_logical_argmax(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarInteger(@intCast(convert.argmaxLogical(vec)));
}
