...
const BenchAltInteger = altrep_create.AltInteger("zigrbench", "bench_altinteger_owned_argmax");
...
export fn zigr_bench_owned_altrep_int_argmax(n_sexp: SEXP) SEXP {
    ...
    return R.Rf_ScalarInteger(@intCast(convert.argmaxInt(vec)));
}
